...
class SetRobotPoseResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'tug_stage_ros/SetRobotPoseResponse';
  }
...
module.exports = {
  ...
  md5sum() { return 'b71344c0ba01936756dc45bcd89ef437'; },
  datatype() { return 'tug_stage_ros/SetRobotPose'; }
};
